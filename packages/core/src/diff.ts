/** Operation to add a value to an object or array. */
export type ObjectPatchAdd = ['a', string, any]
/** Operation to set/replace a value in an object. */
export type ObjectPatchSet = ['s', string, any]
/** Operation to remove a value from an object or array. */
export type ObjectPatchRemove = ['d', string]

/** A single patch operation. */
export type ObjectPatchOp = ObjectPatchAdd | ObjectPatchSet | ObjectPatchRemove
/** A collection of patch operations representing a diff. */
 ...
 *
 * @param from - The initial object state.
 * @param to - The target object state.
...
/**
 * Applies a set of diff operations to an object to produce a new state.
 *
 * @param value - The current object state.
 * @param diff - The patch operations to apply.
 * @returns The new object state.
 */
